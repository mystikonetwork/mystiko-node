...
impl Account {
  ...
  pub fn create(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::create::<&[u8]>(request.as_ref()).encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn count(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::count::<&[u8]>(request.as_ref()).encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn count_all(&self) -> Buffer {
    let r = mystiko_lib::handler::account::count_all().encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn find(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::find::<&[u8]>(request.as_ref()).encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn find_all(&self) -> Buffer {
    let r = mystiko_lib::handler::account::find_all().encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn find_by_id(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::find_by_id::<&[u8]>(request.as_ref()).encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn find_by_shielded_address(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::find_by_shielded_address::<&[u8]>(request.as_ref())
      .encode_to_vec();
    Buffer::from(r)
  }
  ...
  pub fn update_by_id(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::update_by_id::<&[u8]>(request.as_ref()).encode_to_vec();
    Buffer::from(r)
  }

  #[napi]
  pub fn update_by_shielded_address(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::update_by_shielded_address::<&[u8]>(request.as_ref())
      .encode_to_vec();
    Buffer::from(r)
  }
  ...
  pub fn update_by_public_key(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::update_by_public_key::<&[u8]>(request.as_ref())
      .encode_to_vec();
    Buffer::from(r)
  }
  ...
  pub fn export_secret_key_by_id(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::export_secret_key_by_id::<&[u8]>(request.as_ref())
      .encode_to_vec();
    Buffer::from(r)
  }
  ...
  pub fn export_secret_key_by_shielded_address(&self, request: Buffer) -> Buffer {
    let r = mystiko_lib::handler::account::export_secret_key_by_shielded_address::<&[u8]>(
      request.as_ref(),
    )
    .encode_to_vec();
    Buffer::from(r)
