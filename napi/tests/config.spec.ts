...
const { GetConfigResponse } = api.config.v1;
const { FindDefaultCircuitRequest, FindDefaultCircuitResponse } = api.config.v1;
const { FindCircuitRequest, FindCircuitResponse } = api.config.v1;
const { FindChainRequest, FindChainResponse } = api.config.v1;
const { FindPeerChainsRequest, FindPeerChainsResponse } = api.config.v1;
const { FindAssetSymbolsRequest, FindAssetSymbolsResponse } = api.config.v1;
const { FindBridgesRequest, FindBridgesResponse } = api.config.v1;
const { FindBridgeRequest, FindBridgeResponse } = api.config.v1;
const { FindDepositContractRequest, FindDepositContractResponse } = api.config.v1;
const { FindDepositContractByAddressRequest, FindDepositContractByAddressResponse } = api.config.v1;
const { FindPoolContractRequest, FindPoolContractResponse } = api.config.v1;
const { FindPoolContractsRequest, FindPoolContractsResponse } = api.config.v1;
const { FindPoolContractByAddressRequest, FindPoolContractByAddressResponse } = api.config.v1;
const { FindContractByAddressRequest, FindContractByAddressResponse } = api.config.v1;
const { GetTransactionUrlRequest, GetTransactionUrlResponse } = api.config.v1;
