...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.android-arm64.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.android-arm-eabi.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "win32":
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.win32-x64-msvc.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "ia32":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.win32-ia32-msvc.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.win32-arm64-msvc.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "mystiko-napi.darwin-universal.node"),
    );
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.darwin-x64.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.darwin-arm64.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "freebsd":
    ...
    localFileExisted = existsSync(
      join(__dirname, "mystiko-napi.freebsd-x64.node"),
    );
    try {
      if (localFileExisted) {
  ...
  case "linux":
    switch (arch) {
      case "x64":
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, "mystiko-napi.linux-x64-musl.node"),
          );
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, "mystiko-napi.linux-x64-gnu.node"),
          );
          try {
            if (localFileExisted) {
      ...
      case "arm64":
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, "mystiko-napi.linux-arm64-musl.node"),
          );
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, "mystiko-napi.linux-arm64-gnu.node"),
          );
          try {
            if (localFileExisted) {
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "mystiko-napi.linux-arm-gnueabihf.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "riscv64":
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, "mystiko-napi.linux-riscv64-musl.node"),
          );
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, "mystiko-napi.linux-riscv64-gnu.node"),
          );
          try {
            if (localFileExisted) {
