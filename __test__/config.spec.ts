...
const { GetConfigRequest, GetConfigResponse } = api.v1
...
const { FindDepositContractByAddressRequest, FindDepositContractByAddressResponse } = api.v1
...
const { FindPoolContractByAddressRequest, FindPoolContractByAddressResponse } = api.v1
...
test('test get', (t) => {
  ...
  const response = api.get(request.toBinary())
